// PCR3BP.c, https://github.com/bhanson10/gbees-hash/tree/main/examples/PCR3BP
// Copyright 2024 by Benjamin Hanson, published under BSD 3-Clause License.

#include "../../gbees-hash.h" // REF- do not include c files
#include "PCR3BP.h"
...
int main(void){
    ...
    //================================================= GBEES ==================================================//
    run_gbees(PCR3BP, rtrr, PCR3BP_J, G, M, T, P_DIR, M_DIR, NUM_DIST, NUM_MEAS, DEL_STEP, OUTPUT_FREQ, CAPACITY, DIM_h, OUTPUT, RECORD, MEASURE, BOUNDS, COLLISIONS);
